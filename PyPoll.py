...
#Print the final cote vount to the terminal.
    ...
    for candidate in candidate_votes:
        ...
        #AAAAAprint(f"{candidate}: {vote_percentage:.1f}% ({votes:,})\n")
                #BBBB added to print into the text file 3.6.2
        candidate_results = (f"{candidate}: {vote_percentage:.1f}% ({votes:,})\n")
            
            #BBB print each candidate, their voter count and their percentage to terminal
        print(candidate_results)
            #BBB save the cadidate results to txt file
